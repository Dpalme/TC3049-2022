...
class JakenponTest < Minitest::Test
  ...
  # Tests the implementation of the plus operations
  ...
  # Tests the implementation of the minus operations
  ...
  # Tests the implementation of show
  def test_dsl_1
    #---------
    show Spock
    #---------
  ...
  # Tests the implementation of verbose plus
  def test_dsl_2
    #------------------
    show Spock + Lizard
    #------------------
  ...
  # Tests the implementation of verbose minus
  def test_dsl_3
    #------------------
    show Spock - Lizard
    #------------------
  ...
  # Tests the implementation of compound plus
  def test_dsl_4
    #-------------------------
  ...
  # Tests the implementation of PEMDAS plus
  def test_dsl_5
    #---------------------------
    show Spock + (Lizard + Rock)
    #---------------------------
  ...
  # Tests the implementation of PEMDAS minus
  def test_dsl_7
    #--------------------------------------------
    show Rock - Paper - Scissors - Lizard - Spock
    #--------------------------------------------
  ...
  # Tests the implementation of PEMDAS
  def test_dsl_8
    #-------------------------------------------------
    show((Rock + Paper) - (Scissors + Lizard) + Spock)
    #-------------------------------------------------
