...
Authors:: *A01747290* <em>Diego Palmerin</em>
Authors:: *A01748354* <em>Fernando Melgar</em>
Date::      10/06/2022
== Overview
...
=== Development view
    ...
    front/
        ├─ leaderboard
        |     ├─ leaderboard.aws.gateway.rb
        |     └─ leaderboard.interactor.rb
        ├─ question
        |     ├─ question.aws.gateway.rb
        |     └─ question.interactor.rb
        ├─ public/
        |     └─ main.css
        ├─ views/
        |     ├─ error.erb
