# Template Method Pattern Unit Tests
# Date: 03-Mar-2022
# Authors:
...
# Template class to generate Tables
class TableGeneratorTest < Minitest::Test

  # create initial values for the tests
  def setup
    @headerEmpty = []
    @dataEmpty = []
  ...
  # Tests the implementation of CSV Class
  def test_CSVTableGenerator
    assert_equal "Snap,Crackle,Pop\n" +
                 "10,20,30\n" +
                 "12,64,13\n" +
                 "34,11,29\n" +
                 "99,15,34\n",
                 CSVTableGenerator.new(@headerNums, @dataNums).generate
    assert_equal "id,name,grade1,grade2,grade3,average\n" +
  ...
  # Tests the implementation of the HTML Class
  ...
  # Tests the implementation of the AsciiDoc Class
  def test_AsciiDocTableGenerator
    assert_equal "[options=\"header\"]\n" +
                 "|==========\n" +
                 "|Snap|Crackle|Pop\n" +
                 "|10|20|30\n" +
                 "|12|64|13\n" +
