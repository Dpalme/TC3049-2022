...
class CeilingFanHighCommand < _CeilingFanCommand
  def execute
    @last = @fan.speed
    @fan.high
  end
...
class CeilingFanMediumCommand < _CeilingFanCommand
  def execute
    @last = @fan.speed
    @fan.medium
  end
...
class CeilingFanOffCommand < _CeilingFanCommand
  # Stores reference to fan it's current speed
  def execute
    @last = @fan.speed
    @fan.off
